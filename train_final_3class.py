...
# ── Fix imbalance: cap Surgery at 400 samples ──
surgery = df[df['label'] == 'Surgery'].sample(400, random_state=42)
others  = df[df['label'] != 'Surgery']
df      = pd.concat([surgery, others]).sample(frac=1, random_state=42)
